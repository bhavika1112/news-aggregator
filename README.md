...
=======
# NewsHub - React News Aggregator

A modern, responsive news aggregator built with React that displays articles from various categories with filtering capabilities.

## Features

- Clean, modern UI design
- Category filtering (Technology, Business, Entertainment, etc.)
...
>>>>>>> ace01ae (Changed the entire repo from the cloned github one to our own newshub)
